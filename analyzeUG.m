...
for s = 1:length(sublist)
    ...
    for r = 1:runs
        ...
        tmp_data(r,:) = [avg_compFair avg_compUnfair avg_outgroupFair avg_outgroupUnfair avg_ingroupFair avg_ingroupUnfair avg_compFair_logRT avg_compUnfair_logRT avg_outgroupFair_logRT avg_outgroupUnfair_logRT avg_ingroupFair_logRT avg_ingroupUnfair_logRT misses];
    ...
    fprintf(fid_subj,'%d,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f\n',subj,mean(tmp_data));
