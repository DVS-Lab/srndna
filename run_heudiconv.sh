...
FUNC01=\"sub-${sub}_task-sharedreward_run-01_bold.nii.gz\"
FUNC02=\"sub-${sub}_task-sharedreward_run-02_bold.nii.gz\"
FUNC03=\"sub-${sub}_task-trust_run-01_bold.nii.gz\"
FUNC04=\"sub-${sub}_task-trust_run-02_bold.nii.gz\"
FUNC05=\"sub-${sub}_task-trust_run-03_bold.nii.gz\"
FUNC06=\"sub-${sub}_task-trust_run-04_bold.nii.gz\"
FUNC07=\"sub-${sub}_task-trust_run-05_bold.nii.gz\"
FUNC08=\"sub-${sub}_task-ultimatum_run-01_bold.nii.gz\"
FUNC09=\"sub-${sub}_task-ultimatum_run-02_bold.nii.gz\"
